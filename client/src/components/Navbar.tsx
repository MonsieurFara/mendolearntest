    ...
    return (
        <nav className="navbar navbar-expand-lg">
            <div className="container-fluid">
                <span className="navbar-brand"><img src="/assets/logo.jpg" width={60} className="img-fluid" alt="Default User"/></span>
                
                <span className='nav-item'><i className="fas fa-bell"></i></span>
                <ul className="nav">
                    { !isAuthenticated && 
                        <React.Fragment>
